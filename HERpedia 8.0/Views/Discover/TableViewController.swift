...
class TableViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UISearchResultsUpdating {
    ...
    func initList() {
        ...
        let gwcclub = Opportunity(name: "Girls Who Code Club Leader (Recruiting)", desc: "At school, I am involved in several interest clubs, including the French Club and Mentari's Consulting Group, which is a club that aims to expose STEM-oriented students to research opportunities and pair them with business-minded students who are capable of turning the results of research into sustainable enterprises. While outside of school, some of my extra-curricular activities include coding and animation.", imageName: "gwc club", extra: "At school, I am involved in several interest clubs, including the French Club and Mentari's Consulting Group, which is a club that aims to expose STEM-oriented students to research opportunities and pair them with business-minded students who are capable of turning the results of research into sustainable enterprises. While outside of school, some of my extra-curricular activities include coding and animation.")
