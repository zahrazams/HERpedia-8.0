...
class TableViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UISearchResultsUpdating {
    ...
    func initList() {
        let ai4all = Opportunity(name: "AI4ALL Program", desc: "Discover AI is a virtual program that offers a hands-on introduction to computer science and artificial intelligence, ethical issues surrounding AI implementation, and tech careers. Students will complete the program with a certificate of completion and ideas for next steps to take in pursuing an academic or career path related to AI.", imageName: "ai4all", extra: "- Must be a freshmen, sophomores, or a junior at the time of application \n- Open to students with and without prior computer science or AI experience")
        opportunityList.append(ai4all)
        
        let bytespiece = Opportunity(name: "Bytes & Pieces Workshop Mentor (Recruiting)", desc: "Bytes & Pieces is a student-run organization based in the USA who strives to develop students' passions in coding and music and inspire students to pursue careers in computing and/or music. Due to an expansion of their reach, they are opening several new positions on their team to accomodate their growth.", imageName: "bytes", extra: "At school, I am involved in several interest clubs, including the French Club and Mentari's Consulting Group, which is a club that aims to expose STEM-oriented students to research opportunities and pair them with business-minded students who are capable of turning the results of research into sustainable enterprises. While outside of school, some of my extra-curricular activities include coding and animation.")
